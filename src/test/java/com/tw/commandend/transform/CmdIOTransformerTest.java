...
public class CmdIOTransformerTest {
    ...
    public void should_get_stu_when_input_correct_text() throws Exception {
        ...
        //When
        Student StudentInfo = inputTransformer.formatStudent(studentInfoInput);
    ...
    @Test
    public void should_get_empty_stu_list_when_input_no_match_input() throws Exception {
        //Given
        String StudentInfoInput = "1, any wrong initDisplay";

        //When
        List<Student> stus = inputTransformer.formatStudentNos(StudentInfoInput);
    ...
    @Test
    public void should_get_stu_list_when_input_num_text() throws Exception {
        //Given
    ...
    @Test
    public void should_get_deduplicated_stu_list_when_input_repeat_nums_text() throws Exception {
        //Given
    ...
    @Test
    public void should_get_report_format_when_input_correct_report() throws Exception {
        //Given
